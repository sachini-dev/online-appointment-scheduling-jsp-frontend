...
<%
  ...
  if(!(msg.equals("LOGIN-PASS")) && !(type.equals("3"))) {
    response.sendRedirect("../companyLogin.jsp");
  } else if (msg.equals("LOGIN-PASS") && type.equals("3") && !(user.equals(""))){
        ...
        <div class="row">
          <div class="col-12">
            <h2 class="w-100 p-3 mb-2 bg-secondary text-white text-center rounded">
              Welcome to Online Appointment Scheduling Reception Dashboard</h2>
          </div>
        </div>
        <!-- /.row -->
      </div><!-- /.container-fluid -->
...
<!-- Other JS file -->
<script src="js/reception-script.js"></script>
</body>
</html>
